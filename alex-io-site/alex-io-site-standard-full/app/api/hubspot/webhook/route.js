...
export async function POST(req) {
  try {
    ...
    for (const e of events) {
      ...
      // act only on new inbound messages
      const isNewInbound =
    ...
    // always 200 so HubSpot doesn’t retry-storm
