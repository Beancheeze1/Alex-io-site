...
//  - "Your sales link" (below) is the logged-in user's own data from
//    /api/my-quotes -- this used to live on a separate /my-quotes page,
//    folded in here so reps have one page instead of two nearly-identical
//    ones. "Your commission" and expense tracking (incl. Misc/Special
//    Items and Close a month) used to live here too but have moved to
//    /admin/commissions and /admin/expenses respectively, which now
//    render a trimmed, rep-only view of those pages for a sales-role user
//    (see components/rep/MyCommissionPanel.tsx and MyExpensesPanel.tsx).
...
export default function AdminQuotesPage() {
  ...
  // "Your sales link" -- the logged-in user's own data, formerly on a
  // separate /my-quotes page. "Your commission" and expense tracking (incl.
  // Misc/Special Items and Close a month) now live on /admin/commissions
  // and /admin/expenses respectively -- see MyCommissionPanel /
  // MyExpensesPanel, which render there instead.
